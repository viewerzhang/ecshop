                ...
                <div>
                    <form role="form" action="/admin/goodscategory" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input style="width: 100px;display: inline;" type="number" name="cate_sort" class="form-control" id="cate_sort" placeholder="序号">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">分类名称：</label>
                            <input type="text" name="cate_name" class="form-control" id="exampleInputPassword1" placeholder="请输入分类名称">
                        </div>
                        <div class="form-group">
                            <label for="cate_desc">分类描述：</label>
                            <input type="text" name="cate_desc" class="form-control" id="cate_desc" placeholder="请输入分类名称">
                        </div>
