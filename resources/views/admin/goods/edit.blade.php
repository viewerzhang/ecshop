                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="/admin/goods/{{$data->id}}"  method="post" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="请填写名称" name="goods_name" required="" type="text" value="{{$data->goods_name}}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="请填写标语" name="goods_title" required="" type="text" value="{{$data->goods_title}}">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <br>
                        <div class="form-group">
                        	...
                        	<label class="col-lg-2 control-label">商品主图</label>
                                        ...
                                        <div class="help-block col-sm-4 red" style=" height: 50px;margin-top: -13px">
                                            <img src="{{'/static/admin/images/goods_img/'.$data->goods_img}}" alt="" height="50px" style="margin-top:-2px;border: 1px #ddd solid;">
                                        </div>
                         ...
                         <div class="form-group">
                                        ...
                                        <div class="col-sm-2" style="margin-top: 5px">
                                            <input name="goods_imgs[]" type="file" multiple="true">
                                        </div>
                                        <div class="help-block col-sm-4 red" style="height: 50px;margin-top: -13px;display: inline-block;">
                                            @foreach ($goodsimgs as $k=>$v)
                                                <img src="{{'/static/admin/images/goods_imgs/'.$v->goods_imgs}}" alt="" height="50px" style="margin-top:-2px;border:1px  #ddd  solid;" >
                                           @endforeach
                                        </div>
                                    </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="col-sm-offset-1">
                                <input type="radio" class="colored-blue" name="goods_status" checked="checked" value="1" @if($data->goods_status=='1') checked="checked" @endif>
                                <span class="text">是</span>
                            </label>
                            <label style="margin-left: 20px;">
                                <input type="radio" class="colored-danger" name="goods_status" value="2" @if($data->goods_status=='2') checked="checked" @endif>
                        ...
                        <div class="form-group">
                          ...
                          <select name="cate_id" class="form-control">
                                ...
                                @foreach($cate as $k => $v)
                                    <option value="{{ $v->id }}" @if($v->id == $data->cate_id) selected @endif>{{ $v->catenamea }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                               <select name="type_id" class="form-control">
                                ...
                                @foreach($type as $k => $v)
                                    <option value="{{ $v->id }}" @if($v->id == $data->type_id) selected @endif> |-- {{ $v->type_name }}</option>
                                @endforeach
                            </select>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                @foreach($brand as $k => $v)
                                    <option value="{{ $v->id }}" @if($v->id == $data->brand_id) selected @endif> |-- {{ $v->brand_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="￥:124.11(保留小数点后两位)" name="markte_price" required="" type="text" value="{{$data->markte_price}}">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="￥:124.11(保留小数点后两位)" name="goods_price" required="" type="text" value="{{$data->goods_price}}">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="请填写点击数量" name="click_num" required="" type="text" value="{{$data->click_num}}">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="请填写商品重量" name="goods_weight" required="" type="text" value="{{$data->goods_weight}}">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="请填写库存数量" name="goods_num" required="" type="text" value="{{$data->goods_num}}">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
