            ...
            <div class="col-md-12">
                <div class="bend niceties preview-2">
                    <div id="ensign-nivoslider" class="slides">
                        ...
                        <img src="/static/admin/images/lunbo/{{ $v->lunbo_img }}" 
                        style="width: 1140;height: 423;" alt="" title="#slider-caption-2" />
                        @endforeach
                        ...
                        <div class="blog">
                            <div class="new_product">
                                <div class="product_heading">
                                    ...
                                    <span><a href="/articles">精选文章</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/articles"><font style="font-size: 17px">查看更多</font></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="blog_carasel indicator-brand indicator-brand-6">
                        ...
                        <div class="col-md-12">
                            <div class="blog_next">
                                ...
                                <div class="blog_info">
                                    <h3 class="post-title">
                                        <a href="/articles?id={{$v->id}}">{{ $v->art_title }}</a>
                                    </h3>
                                    <div class="post-excerpt" style="width: 200px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">{!! mb_substr($v->art_desc,0,100) !!}</div>
                                    <a href="/articles?id={{$v->id}}">
